...
| `PROBE_0008` Parallel Path / 并行路径 | Candidate create/close/compare/select; hypothesis, evidence, method version, validation, elimination, selection. / 候选创建/关闭/比较/选择；假设、证据、方法版本、验证、淘汰、选择。 | Paraphrase candidates, shared unverified premise, missing common criteria, score-selection conflict, no validation gain. / 同义改写、共享未验证前提、无统一标准、评分与选择冲突、无验证收益。 | Material difference, completion, convergence, winner validation, invalid parallel cost. / 实质差异率、完成率、收敛率、胜出验证率、无效并行成本。 |
