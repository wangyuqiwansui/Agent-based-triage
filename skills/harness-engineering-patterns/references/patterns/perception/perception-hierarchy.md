...
Cell / 交织点: perception-hierarchy / 感知 x 层级
...
- 论文坐标 / Article Coordinate: Perception / 感知 x Hierarchy / 层级 (Hierarchy / 层级).
...
- 问题 / Problem: The article leaves this intersection unnamed; use it only if workflow evidence shows that Perception / 感知 needs Hierarchy / 层级. / 论文未命名该交织点；仅当工作流证据表明 Perception / 感知 需要 Hierarchy / 层级 时使用。
...
- 适用工作流节点 / Applicable Workflow Nodes: 上下文感知、治理审查 / Context sensing, governance review.
- 当前症状 / Current Symptoms: 待根据当前工作流诊断 / Diagnose from the current workflow.
- 适配信号 / Fit Signals: 信号需要按系统、模块、任务或风险层级组织 / Signals must be organized by system, module, task, or risk level.
...
Observability Metrics File / 可观测性指标文件: [perception-hierarchy-observability.md](perception-hierarchy-observability.md)
