# Failure Journal / 失败日志 Observability Metrics / 可观测性指标
...
Use these metrics to observe whether Failure Journal / 失败日志 improves the workflow after selection or application. / 使用以下指标观察 Failure Journal / 失败日志 在选型或应用后是否改善工作流。
