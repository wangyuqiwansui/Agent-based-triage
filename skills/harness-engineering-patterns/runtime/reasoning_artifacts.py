...
_SCHEMA_FILES = {
    "capability_credential": "capability-credential.schema.json",
    "generator_critic_artifact": "generator-critic-artifact.schema.json",
    "generator_critic_contract": "generator-critic-contract.schema.json",
    "generator_critic_decision": "generator-critic-decision.schema.json",
    "generator_critic_event": "generator-critic-event.schema.json",
    "generator_critic_receipt": "generator-critic-receipt.schema.json",
    "generator_critic_review": "generator-critic-review.schema.json",
    ...
    "reflection_contract": "reflection-contract.schema.json",
    "reflection_event": "reflection-event.schema.json",
    "reflection_round_observation": "reflection-round-observation.schema.json",
    "skill_package_alias_receipt": "skill-package-alias-receipt.schema.json",
    "skill_package_candidate": "skill-package-candidate.schema.json",
    "skill_package_contract": "skill-package-contract.schema.json",
    "skill_package_evaluation": "skill-package-evaluation.schema.json",
    "skill_package_event": "skill-package-event.schema.json",
    "skill_package_manifest": "skill-package-manifest.schema.json",
    "skill_package_reuse_receipt": "skill-package-reuse-receipt.schema.json",
...
_HASH_FIELDS = {
    "capability_credential": "credential_hash",
    "generator_critic_artifact": "artifact_record_hash",
    "generator_critic_contract": "contract_hash",
    "generator_critic_decision": "decision_hash",
    "generator_critic_event": "event_hash",
    "generator_critic_receipt": "receipt_hash",
    "generator_critic_review": "review_hash",
    ...
    "reflection_contract": "contract_hash",
    "reflection_event": "event_hash",
    "reflection_round_observation": "observation_hash",
    "skill_package_alias_receipt": "alias_receipt_hash",
    "skill_package_candidate": "candidate_hash",
    "skill_package_contract": "contract_hash",
    "skill_package_evaluation": "evaluation_hash",
    "skill_package_event": "event_hash",
    "skill_package_manifest": "manifest_hash",
    "skill_package_reuse_receipt": "reuse_receipt_hash",
